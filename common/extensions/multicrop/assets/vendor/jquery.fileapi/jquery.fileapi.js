...
(function ($, api){
    ...
    Plugin.prototype = {
        ...
        _onUploadEvent: function (evt, ui){
            ...
            if( type == 'progress' ){
//                $progress.css({width: '100%'}).addClass('active');
//                $progress.attr('aria-valuenow', 100);
                /*$progress.stop().animate({ width: ui.loaded/ui.total*100 + '%' }, {duration: 300, step: function(val){
                    $(this).attr('aria-valuenow', val);
                }});*/
            }
            else if( type == 'upload' ){
                // Начало загрузки
//                $progress.width(0).removeClass('active');
...
//                $progress.attr('aria-valuenow', 100);
                ...
                $progress.attr('aria-valuenow', ui.loaded/ui.total*100);*/
            }
